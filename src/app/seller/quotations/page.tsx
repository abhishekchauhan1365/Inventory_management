...
// Redesigned: Awwwards-style expandable quotation rows
...
export default function SellerQuotations() {
  ...
  return (
    <div>
      <div className="mb-10">
        <h1 className="text-3xl font-extrabold tracking-tight text-zinc-900">My Quotations</h1>
        <p className="mt-2 text-sm font-medium text-zinc-500">Track your order statuses and history</p>
      </div>
      ...
      {quotations.length === 0 ? (
        <div className="flex h-64 flex-col items-center justify-center rounded-3xl border border-zinc-200 border-dashed bg-white/50 text-zinc-500">
          ...
          <p className="font-medium">You haven't placed any quotations yet.</p>
        </div>
      ) : (
              ...
              >
                ...
                >
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <h3 className="font-bold text-zinc-900">Quotation #{q.id}</h3>
                  ...
                  <div className="border-t border-zinc-100 bg-zinc-50/50 px-6 pb-6 pt-5">
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full text-left text-sm">
                        <thead>
                          <tr className="border-b border-zinc-200 text-zinc-400 font-semibold tracking-wide">
                            <th className="pb-3 pr-4 font-semibold uppercase text-xs">Product</th>
                            <th className="pb-3 px-4 font-semibold uppercase text-xs">Ordered Qty</th>
                            <th className="pb-3 px-4 font-semibold uppercase text-xs">Base Qty</th>
                            <th className="pb-3 px-4 font-semibold uppercase text-xs text-right">Price Rate</th>
                            <th className="pb-3 pl-4 font-semibold uppercase text-xs text-right">Line Total</th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-zinc-100">
                          {q.items?.map(item => (
                            <tr key={item.id} className="group hover:bg-zinc-100/50 transition-colors">
                              ...
                              <td className="py-4 pl-4 text-right font-bold text-zinc-900">
                        ...
                        <tfoot>
                          <tr className="border-t border-zinc-200">
                            ...
                            <td className="py-4 pl-4 text-right text-lg font-extrabold text-zinc-900">
